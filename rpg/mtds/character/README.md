...
A comprehensive list of things to fix or improve in the current iteration of the Character Generator. New features will only be included if needed in order to fix something.
